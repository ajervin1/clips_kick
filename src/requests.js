...
export async function getClipsByChannel( channel, cursor = 0, sort = "view", time = "all" ) {
...
export async function getClipsByCategory( category, cursor = 0, sort = "view", time = "all" ) {
